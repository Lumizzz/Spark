  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative" style={{ background: 'var(--color-bg)' }}>
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(124,58,237,0.4) 0%, transparent 60%)' }}
      />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mt-4" style={{ fontFamily: 'var(--font-display)' }}>
            {mode === 'login' ? 'Welcome back' : 'Create an account'}
          </h1>
          <p className="text-slate-400 text-sm mt-1">
            {mode === 'login' ? 'Sign in to your dashboard' : 'Get started for free'}
          </p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="mt-6 text-center">
            ...
            >
              ...
              <span className="text-purple-400">{mode === 'login' ? 'Sign up' : 'Sign in'}</span>
            </button>
          </div>
        </div>
      </div>
