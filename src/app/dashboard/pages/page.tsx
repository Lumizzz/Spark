...
import { Plus, Edit, Eye, FileText, Copy, Tag } from 'lucide-react';
import { getAllPages, deletePage, togglePageStatus, duplicatePage } from '@/lib/actions';
import { formatDate } from '@/lib/utils';
import DeleteButton from '@/components/dashboard/DeleteButton';
import QuickToggle from '@/components/dashboard/QuickToggle';
import DuplicateButton from '@/components/dashboard/DuplicateButton';
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white" style={{ fontFamily: 'var(--font-display)' }}>Pages</h1>
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        ...
        {pages.length === 0 ? (
          <div className="px-6 py-16 text-center">
            ...
            <p className="text-slate-500">No pages yet. <Link href="/dashboard/pages/new" className="text-purple-400">Create one →</Link></p>
          </div>
        ) : (
          <div className="divide-y divide-white/5">
            {pages.map((page) => (
              <div key={page.id} className="grid grid-cols-[1fr,auto,auto,auto] gap-4 px-6 py-4 items-center hover:bg-white/2 transition-colors">
                ...
                <QuickToggle id={page.id} currentStatus={page.status} action={togglePageStatus} />
                ...
                <div className="flex items-center gap-1">
                  ...
                  <DuplicateButton id={page.id} action={duplicatePage} />
